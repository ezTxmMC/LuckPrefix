...
public class ConfigUtil {
    ...
    public static ConfigManager addDatabaseDefault(String fileName) {
        ...
        configManager.addDefault("Database.MariaDB.Database", "de/eztxm/luckprefix");
        configManager.addDefault("Database.MariaDB.User", "de/eztxm/luckprefix");
        ...
        configManager.addDefault("Database.MongoDB.Database", "de/eztxm/luckprefix");
        configManager.addDefault("Database.MongoDB.User", "de/eztxm/luckprefix");
